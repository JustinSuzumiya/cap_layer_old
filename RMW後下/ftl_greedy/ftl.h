...
#define P_BANK_BYTES		(sizeof(UINT32) * P_MAX + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR
...
#define P_ISSUE_FLAG_BYTES	(sizeof(UINT16) * P_MAX + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR
